...
export const sidebarNavigation: SidebarGroup[] = [
  {
    ...
    items: [
      ...
      { href: '/studio/scenes', label: 'Scenes', icon: 'Film' },
      { href: '/studio/backgrounds', label: 'Backgrounds', icon: 'Image' },
      { href: '/studio/gallery', label: 'Gallery', icon: 'LayoutGrid' },
    ],
  },
  {
    title: 'AI Tools',
    items: [
      ...
      { href: '/studio/tools/pose-creator', label: 'Pose Creator', icon: 'UserSquare' },
      ...
      { href: '/studio/tools/ai-assistant', label: 'AI Assistant', icon: 'Bot' },
      { href: '/studio/tools/translation', label: 'Translation', icon: 'Languages' },
